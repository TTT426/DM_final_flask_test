...
{
    fetch(`http://localhost:3000/winnerlist?years=${year.value}`)
    .then(res => res.json())
    .then(async winnerData => {
        async function fetchPlayer(playerId) {
            try {
                const res = await fetch(`http://localhost:3000/players?player_unique_id=${playerId}`);
        ...
        document.getElementById('player_hitKing').setAttribute('player_unique_id', winnerData[0].most_hits_player_id);
        document.getElementById('player_highest_batting').setAttribute('player_unique_id', winnerData[0].highest_batting_average_player_id);
        document.getElementById('player_most_stolen_bases').setAttribute('player_unique_id', winnerData[0].most_stolen_bases_player_id);
        document.getElementById('player_RBI').setAttribute('player_unique_id', winnerData[0].most_RBI_player_id);
        document.getElementById('player_most_wins').setAttribute('player_unique_id', winnerData[0].most_wins_player_id);
        document.getElementById('player_most_saves').setAttribute('player_unique_id', winnerData[0].most_saves_player_id);
        document.getElementById('player_most_holds').setAttribute('player_unique_id', winnerData[0].most_holds_player_id);
        document.getElementById('player_strikeout').setAttribute('player_unique_id', winnerData[0].strikeout_leader_player_id);
        document.getElementById('player_homerun').setAttribute('player_unique_id', winnerData[0].homerun_leader_player_id);
        document.getElementById('player_lowest_ERA').setAttribute('player_unique_id', winnerData[0].lowest_ERA_player_id);
    })
...
submitButton.addEventListener('click', (event) => {
    const highest_batting_average = document.getElementById('player_highest_batting').getAttribute('player_unique_id');
    const hitKing = document.getElementById('player_hitKing').getAttribute('player_unique_id');
    const RBI_player = document.getElementById('player_RBI').getAttribute('player_unique_id');
    const most_stolen_bases_player = document.getElementById('player_most_stolen_bases').getAttribute('player_unique_id');
    const homerun_leader_player = document.getElementById('player_homerun').getAttribute('player_unique_id');
    const most_wins_player = document.getElementById('player_most_wins').getAttribute('player_unique_id');
    const strikeout_leader_player = document.getElementById('player_strikeout').getAttribute('player_unique_id');
    const lowest_ERA_player = document.getElementById('player_lowest_ERA').getAttribute('player_unique_id');
    const most_saves_player = document.getElementById('player_most_saves').getAttribute('player_unique_id');
    const most_holds_player = document.getElementById('player_most_holds').getAttribute('player_unique_id');
    ...
    fetch(`http://localhost:3000/winnerlist/${year.value}`, {
        'method': 'PATCH',
        'headers': {
